...
class kMaXDeepLab(nn.Module):
    ...
    def from_config(cls, cfg):
        ...
        # building criterion
        matcher = HungarianMatcher(masking_void_pixel=cfg.MODEL.KMAX_DEEPLAB.MASKING_VOID_PIXEL)
        ...
        return {
            ...
            "pixel_confidence_threshold": cfg.MODEL.KMAX_DEEPLAB.TEST.PIXEL_CONFIDENCE_THRESHOLD,
    ...
    def forward(self, batched_inputs):
        ...
        ## fixme Pad the images to input space defined in config... why?
    ...
    def instance_inference(self, mask_cls, mask_pred):
        ...
        result.pred_masks = (mask_pred > self.pixel_confidence_threshold).float()
